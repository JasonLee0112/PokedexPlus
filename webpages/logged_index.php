...
<html>
    ...
    <body>
        ...
        <div class="container mt-5 border border-dark">
            <div class="row justify-content-center bg-secondary h-25">
                <div class="col-md-4 justify-content-center border border-dark">
                    Pokedex
                </div>
                <div class="col-md-4 justify-content-center border border-dark">
                    Teams
            ...
            <div class="row justify-content-center bg-primary h-25">
                <div class="col-md-4 justify-content-center border border-dark">
                    G
                </div>
                <div class="col-md-4 justify-content-center border border-dark">
